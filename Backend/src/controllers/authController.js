...
//     website,
//   });
//   if (!org) throw new ApiError(500, "Error creating organization");
...
//   }
//   const safeUser = await User.findById(adminUser._id).select("-password -refreshToken");
...
//     organization: org,
//     action: "REGISTER_ORG",
//     details: { info: "Organization registered successfully with default admin" },
//   });

//   return res.status(201).json(new ApiResponse(201, { organization: org, admin: safeUser }, "Organization registered successfully"));
// });
...
//   if (!organization) throw new ApiError(401, "Invalid credentials");

//   const isMatch = await organization.isPasswordCorrect(password);
...
//     .json(new ApiResponse(200, { organization, accessToken }, "Organization logged in successfully"));
// });
